...
BingX. Сделать единый Exchange Adapter Layer." На MVP полностью рабочая
реализация только BingX (services/exchanges/bingx.py) — остальные биржи
из SUPPORTED_EXCHANGES (services/exchanges/registry.py) архитектурно
предусмотрены, но ещё не реализованы.
