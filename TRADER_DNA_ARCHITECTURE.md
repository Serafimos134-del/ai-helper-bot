...
> **⚠️ Заменено.** По итогам аудита в этом документе (§1: найдены три
> независимых работающих движка аналитики + мёртвый код персонализации)
> курс изменён с "построить Trader DNA поверх существующего" на
> "консолидировать существующий интеллект проекта в единый слой". Текущий
> проектный документ — **`TRADER_INTELLIGENCE_ARCHITECTURE.md`**. Этот файл
> оставлен как запись хода рассуждения, не как актуальный план.
